...
| 파일 | 개수 | 용도 |
|---|---:|---|
| **`master_ethereum_confirmed.csv`** | 23,086 | 🥇 **차단/스크리닝용 (권장)** — 아래 3개 확정 등급만 |
| `master_ethereum_etherscan_confirmed.csv` | 21,733 | 🔒 최엄격 — Etherscan 공식 악성만 |
| `master_ethereum_verified.csv` | 217,411 | 🔍 전체 감사본 (모든 주소 + tier 컬럼) |
